    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult MyPets()
        {
            return View(_dataContext.Pets
                ...
                .Where(p => p.Owner.User.Email.ToLower() == (User.Identity.Name.ToLower())));
        }
        ...
        public async Task<IActionResult> Edit(PetViewModel view)
        {
            ...
            view.PetTypes = _combosHelper.GetComboPetTypes();
            return View(view);
        }
        ...
        public async Task<IActionResult> Assing(AgendaViewModel view)
        {
            ...
            view.Pets = _combosHelper.GetComboPets(view.OwnerId);
            return View(view);
        }
